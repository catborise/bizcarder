        ...
        <div className="fade-in">
            ...
            >
                ...
                <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column', gap: '5px' }}>
                    <label style={{ color: 'var(--text-tertiary)', fontSize: '0.85rem' }}>
                        {t('pages:activityLogs.searchLabel')}
                    </label>
                    <input
                        type="text"
                ...
                <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                        <label style={{ color: 'var(--text-tertiary)', fontSize: '0.85rem' }}>
                            {t('pages:activityLogs.startDate')}
                        </label>
                        <input
                            type="date"
                            value={startDate}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                    <label style={{ color: 'var(--text-tertiary)', fontSize: '0.85rem' }}>
                        {t('pages:activityLogs.sort')}
                    </label>
                    <div
                        style={{ display: 'flex', background: 'var(--bg-input)', borderRadius: '8px', padding: '2px' }}
                    >
                        <button
                            ...
                            >
                                ...
                                >
                                    {log.user
                                        ...
                                        : t('pages:activityLogs.anonymous')}
                                </div>
