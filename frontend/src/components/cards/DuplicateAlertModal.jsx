    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={t('addCard.duplicate.title')}>
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', marginBottom: '25px', marginTop: 0 }}>
                    <Trans
                        i18nKey="cards:addCard.duplicate.description"
                        values={{ firstName: duplicateCard.firstName, lastName: duplicateCard.lastName }}
                        components={{ 1: <b /> }}
                    />
                </p>
                ...
                >
                    <div style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '8px', fontSize: '0.9rem' }}>
                        ...
                        <span style={{ color: 'var(--accent-success)' }}>
                            @{duplicateCard.owner?.displayName || 'Sistem'}
                        </span>
                    </div>
                </div>
