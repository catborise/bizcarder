        ...
        if (navigator.share) {
            try {
                await navigator.share({
                    title: t('pages:myCard.shareTitle', {
                        firstName: personalCard.firstName,
                        lastName: personalCard.lastName,
                    }),
                    text: t('pages:myCard.shareText', {
                        company: personalCard.company,
                        ...
                        <div className="mycard-profile-body">
                            ...
                            >
                                {personalCard.frontImageUrl ? (
                                    <img
                                        src={`${API_URL}${personalCard.frontImageUrl}`}
                                        alt={t('pages:myCard.cardFrontAlt')}
                            ...
                            >
                                {personalCard.title}
                                {personalCard.company && ` @ ${personalCard.company}`}
                            </p>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
                                ...
                                {personalCard.city && (
                                    <ContactRow
                                        ...
                                        value={`${personalCard.city}${personalCard.country ? `, ${personalCard.country}` : ''}`}
                                    />
                                )}
                            </div>
