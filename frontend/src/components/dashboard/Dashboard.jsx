                    ...
                    {isAdmin && (
                        <>
                            <button
                                ...
                                style={{
                                    padding: '10px 20px',
                                    background: editMode ? 'var(--accent-primary)' : 'var(--glass-bg)',
                                    ...
                                    boxShadow: editMode ? 'var(--glass-shadow-hover)' : 'var(--glass-shadow)',
                                }}
                        ...
                        >
                            {loading ? (
                                <div
                                    ...
                                    style={{ width: '70px', height: '64px', borderRadius: '12px' }}
                                ></div>
                            ) : (
                                stats.totalCards
                            )}
                    ...
                    >
                        ...
                        >
                            {loading ? (
                                <div
                                    className="skeleton-box"
                                    style={{ width: '60px', height: '64px', borderRadius: '12px' }}
                                ></div>
                            ) : (
                                (stats.thisWeek ?? 0)
                            )}
                    ...
                    >
                        ...
                        >
                            {loading ? (
                                <div
                                    className="skeleton-box"
                                    style={{ width: '50px', height: '64px', borderRadius: '12px' }}
                                ></div>
                            ) : (
                                dueReminders.length
                            )}
                    ...
                    {loading
                        ...
                        : tiles
                              ...
                              .map((tile, i) => {
                                  ...
                                  const wrapperProps = tile.isInternal
                                      ? { to: tile.url }
                                      : { href: tile.url, target: tile.url.startsWith('http') ? '_blank' : '_self' };
